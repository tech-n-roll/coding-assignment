...
public class ConveyorGraph implements Graph<ConveyorNode, ConveyorLink> {
    ...
    public boolean contains(ConveyorNode node) {
        return neighbors.containsKey(node);
    }

    public boolean contains(ConveyorLink link) {
    ...
    @Override
    public Iterable<ConveyorNode> getVertices() {
        return nodes;
    }
    ...
    @Override
    public Iterable<ConveyorLink> getEdges() {
        return links;
    }
    ...
    @Override
    public boolean containsVertex(ConveyorNode conveyorNode) {
        return false;
    }

    @Override
    public boolean containsEdge(ConveyorLink conveyorLink) {
        return false;
    }
